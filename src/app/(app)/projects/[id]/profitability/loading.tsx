...
export default function ProfitabilityLoading() {
  return (
    <div className="space-y-6 p-4 md:p-6" role="status" aria-busy="true" aria-label="Carregando dashboard de rentabilidade...">
      <span className="sr-only">Carregando...</span>

      {/* Header skeleton */}
      <div className="flex items-center justify-between">
        <div className="h-7 w-40 animate-pulse bg-slate-200 dark:bg-slate-700 rounded" aria-hidden="true" />
        <div className="h-9 w-48 animate-pulse bg-slate-200 dark:bg-slate-700 rounded" aria-hidden="true" />
      </div>
