...
const log = createLogger('api/change-order/approve')
...
export async function PATCH(
  ...
  try {
    ...
    try {
      ...
      log.error({ err: eventErr }, '[CHANGE_ORDER_APPROVED] EventBus falhou:')
    }
    ...
    log.error({ err: error }, '[PATCH /change-orders/[coId]/approve]')
    return NextResponse.json(
